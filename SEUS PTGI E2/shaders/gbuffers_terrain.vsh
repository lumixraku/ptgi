...
*/
	...
	//glowstone and lamp, and lapis, and redstone
	if (
		mc_Entity.x == 89 || mc_Entity.x == 124 
...
//*/
	...
	// vec2 fractionalTexcoord = clamp(mod(texcoord.st * 16.0f, vec2(1.0f / 16.0f)) * 50.0 - 2.0, vec2(0.0), vec2(1.0));
	...
	//gl_Position.xy = (cubeCoord.xz + vec2(fractionalTexcoord.x, fractionalTexcoord.y)) * 0.1;
	//gl_Position.z = 0.5;
	//gl_Position.w = 0.5;
	...
	//gl_Position = vec4(fractionalTexcoord.st * 0.1, 0.0, 1.0);
